...
```
### Making probabilistic botnet table.
```{r}
botnet_prob_result = data.frame(predsrfprobs$Botnet, knnPredict$Botnet, logicRPredict$Botnet, naiveBayesPredict$Botnet ,svmPredict$Botnet)
names(botnet_prob_result) = c('Ramdom Forest','KNN','Logistic Regression', 'Naive Bayes', 'Suport VM')
botnet_prob_result
```
