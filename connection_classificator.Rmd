...
```
```{r}
plot(logicROC, type="S", print.thres= 0.5)
```

### Naive Bayes
```{r}
naiveBayesFit <- train(class ~ ., method='nb', trControl = ctrl_fast,preProcess=c('scale', 'center'), data=training, family=binomial(link='logit'))
